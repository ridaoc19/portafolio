  ...
  return (
    <>
      ...
      <p>
        ...
        Internet. Mi interés en el desarrollo web comenzó en 2018 cuando decidí
        intentar automatizar procesos en la Policía Nacional de Colombia. ¡donde
        cree una aplicacion de escritorio con Visual Basic (VB) que ayudo a
        erradicar una problematica que se tenia con el control de inventario y
